...
## 9. Forward Authentication & SSO Middleware

For full details, architecture diagrams, sequence workflows, and configuration examples for **Forward Authentication, Single Sign-On (SSO), and Authelia / Authentik Integration**, see the dedicated [Forward Authentication Documentation](file:///Users/hughstanway/Projects/Barebones-Reverse-Proxy/docs/auth.md).
